...
function History(props){
    ...
    return (
        <div className="flex h-15 w-full flex-wrap items-center border-x border-b border-sky-100 bg-white/85 text-sm text-slate-600 transition-colors hover:bg-cyan-50/80">
            ...
            <div className="flex flex-wrap gap-20 justify-center">
                <div className="flex h-8 w-40 flex-wrap items-center justify-center rounded-2xl bg-sky-100 text-xs font-semibold text-sky-700">
                    <p>{props.role}</p>
                </div>
                <p>{props.action}</p>
            </div>
