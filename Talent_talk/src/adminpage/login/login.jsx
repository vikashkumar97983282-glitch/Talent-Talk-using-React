...
function Login(){
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center bg-gray-400">
            <div className="h-92.5 w-155 p-7.5 bg-linear-to-br from-blue-500 via-sky-400 to-blue-300 rounded-lg mb-8 flex justify-center shadow-lg ring-1 ring-blue-400">
